    ...
    <div class="card card-container">
      ...
      <Form @submit="handleRegister" :validation-schema="schema">
        <div v-if="!successful">
          ...
          <div class="form-group" id="chooseRole">
            <div class="form-check form-check-inline">
              <Field class="form-check-input" type="radio" name="roles" id="doctor" value="doctor"/>
              <label class="form-check-label" for="doctor">Docteur</label>
            </div>
            <div class="form-check form-check-inline">
              <Field class="form-check-input" type="radio" name="roles" id="patient" value="patient"/>
