...
export default {
  ...
  data() {
    return {
      leave: require("../../assets/video_meet/leave_call.svg"),
      micOn: require("../../assets/video_meet/mic_on.svg"),
      micOff: require("../../assets/video_meet/mic_off.svg"),
      screenShare: require("../../assets/video_meet/screenshare.svg"),
      videoOn: require("../../assets/video_meet/vid_on.svg"),
      videoOff: require("../../assets/video_meet/vid_off.svg"),
